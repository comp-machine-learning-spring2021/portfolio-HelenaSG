...
# input: a numpy array
# returns: a distance matrix as a numpy array
...
# input: a distance matrix as a numpy array
# returns: a binarized numpy array
def binaryMatrix(A):
...
# input: adj_matrix as a numpy array
# returns: unnormalized Laplacian as a numpy array
...
# input: L = unnormalized Laplacian
#        k = the number of clusters
# returns: labels and centers of clusters
